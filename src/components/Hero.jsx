export default function Hero() {
  return (
    <section id="home" className="flex flex-col-reverse lg:flex-row">
      ...
      <div className="lg:w-3/5 flex flex-col gap-10 lg:gap-20 items-center justify-center py-30 bg-[url('/pattern.webp')] bg-cover text-white  overflow-hidden relative ">
        ...
        <button className="font-bold border-3 rounded-4xl  animate-bounce lg:px-10 px-5 drop-shadow-[0_5px_15px_rgba(0,0,0,0.7)] bg-yellow-300 text-slate-800 border-slate-800 hover:border-white lg:py-5 p-3 text-lg lg:text-3xl cursor-pointer hover:bg-gray-800 hover:text-white transition z-1">
          ACQUISTALA SUBITO!
        </button>
      </div>
    </section>
